...
class ProfileScreen extends StatelessWidget {
                      ...
                      child: ValueListenableBuilder<List<Order>>(
                        ...
                        builder: (_, orders, __) {
                          return ValueListenableBuilder<Set<String>>(
                            valueListenable: store.wishlist,
                            builder: (_, wishlist, __) {
                              return Row(
                                ...
                                children: [
                                  ...
                                  _stat('${wishlist.length}', 'WISHLIST'),
                                  Container(
                                      width: 1,
                                      height: 30,
                                      color: AppColors.border),
                                  _stat(
                                      '${orders.fold(0, (sum, o) => sum + o.itemCount)}',
                                      'BOOKS'),
                                ],
                              );
                            },
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 12),
                    _menuGroup([
                      _menuItem(context, Icons.info_outline_rounded,
                          'Help Center', null),
                    ]),
                    const SizedBox(height: 20),
                    // Log Out
                      ...
                      child: Row(
                        ...
                        children: [
                          const Icon(Icons.edit_rounded,
                              size: 14, color: AppColors.primaryLighter),
  ...
  static Widget _menuGroup(List<Widget> items) {
    return Container(
      decoration: BoxDecoration(
  ...
  static Widget _menuItem(
      BuildContext context, IconData icon, String label, String? badge,
      {VoidCallback? onTap}) {
