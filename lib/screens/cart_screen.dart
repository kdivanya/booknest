  ...
  void _checkout() {
    ...
    if (selected.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: const Text('Select at least one item'),
        ...
        body: SafeArea(
          child: Column(
            children: [
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    const Text('Cart', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: AppColors.textDark)),
                  ],
                ),
              ),
              const Spacer(),
              const Icon(Icons.shopping_cart_outlined, size: 80, color: AppColors.primaryLighter),
              const SizedBox(height: 16),
              const Text('Your cart is empty',
                  style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: AppColors.textDark)),
              const SizedBox(height: 8),
              const Text('Explore our collection and find your\nnext favorite book.',
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: const Row(
                      ...
                      children: [
                        Text('Start Exploring', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600)),
                        SizedBox(width: 8),
              ...
              const Spacer(),
              BottomNav(currentIndex: 2, onTap: (_) {}),
            ],
          ),
        ),
      );
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [BoxShadow(color: AppColors.primaryLighter.withValues(alpha: 0.2), blurRadius: 10)],
              ),
              child: Column(
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text('${_store.selectedCount} Items Selected',
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: const Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text('Checkout Now', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600)),
                          SizedBox(width: 8),
                          Icon(Icons.arrow_forward_rounded, size: 16),
                        ],
                      ),
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: item.isSelected ? AppColors.primary : AppColors.borderMid, width: 1.5),
